...
//  Mirascon
//
//  Created by Dev-Notebook on 04.05.20.
//  Copyright © 2020 MIRASCON. All rights reserved.
//

import SwiftUI
/*
struct oldClaimsForm: View {
...
struct OldClaimsForm_Previews: PreviewProvider {
    static var previews: some View {
        ClaimsForm(ViewRouter())
    }
}
struct OldGradientBackgroundStyle: ButtonStyle {
